  ...
  expo: {
    ...
    extra: {
      ...
      GOOGLE_CLIENT_ID: IS_PRODUCTION
        ? "903375841365-ouu6qppo467lvq0jrpmfcloolhqkuvvn.apps.googleusercontent.com"
      ...
      API_BASE_URL: IS_PRODUCTION
        ...
        : "http://192.168.43.14:4000", // Replace with your computer's local IP address
      eas: {
